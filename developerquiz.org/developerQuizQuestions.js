...
function findAns(arr) {
  for (var i = 0; i <= arr.length; i++) {
    console.log("Question " + (i + 1) + ". " + arr[i].Question);
    console.log("Answer " + (i + 1) + ". " + arr[i].Answer);
    console.log("Explanation " + (i + 1) + ". " + arr[i].Explanation);
    console.log("Refer " + (i + 1) + ". " + arr[i].Link);
    console.log("---------------------------------------------------");
  }
}
